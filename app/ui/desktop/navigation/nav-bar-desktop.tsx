                                ...
                                <>
                                    ...
                                    <div className={styles.profileDropdown}>
                                        ...
                                        <div className={styles.dropdownItems}>
                                            ...
                                            <Link href="/manage/favorites" className={styles.dropdownItem} onClick={handleCloseMenu}>
                                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <Link href="/landing-designer" className={styles.dropdownItem} onClick={handleCloseMenu}>
                                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
