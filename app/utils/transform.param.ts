...
export function extractSearchRequest(searchParam: any) {
    const body = {
        query: searchParam.get('query'), minPrice: searchParam.get('minPrice'), maxPrice: searchParam.get('maxPrice'),
        minAcreage: searchParam.get('minAcreage'), maxAcreage: searchParam.get('maxAcreage'),
        cityCode: searchParam.get('city'),
